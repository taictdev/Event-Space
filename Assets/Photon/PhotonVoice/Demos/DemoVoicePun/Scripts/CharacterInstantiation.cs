...
#pragma warning restore 649
    ...
    {
        private SerializedProperty spawnPoints, prefabsToInstantiate, useRandomOffset, positionOffset, autoSpawn, manualInstantiation, differentPrefabs, localPrefabSuffix, remotePrefabSuffix, sequence, manualInstantiationEventCode, virtualCamera;
        ...
        private void OnEnable()
        {
            ...
            this.virtualCamera = this.serializedObject.FindProperty("VirtualCamera");
        }
        ...
        public override void OnInspectorGUI()
        {
            ...
            EditorGUILayout.PropertyField(this.virtualCamera);
